...
def main_menu():
    auto_buy_label = "🤖 Auto Buy 🟢" if user_settings["auto_buy"] == "ON" else "🤖 Auto Buy 🔴"
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("👛 Wallets", callback_data='wallets'), InlineKeyboardButton("💼 Positions", callback_data='positions')],
        [InlineKeyboardButton(auto_buy_label, callback_data='auto_buy'), InlineKeyboardButton("📈 Buy Mode", callback_data='buy_mode')],
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "auto_buy":
        ...
        await query.edit_message_text(f"🤖 Auto Buy toggled to: {user_settings['auto_buy']}", reply_markup=main_menu())
        return
